...
function getBoardSpaces() {
    return [
        ...
        { name: 'Las Vegas Raiders', type: 'property', color: '#8B4513', group: 'brown', price: 350, rent: [35, 70, 200, 550, 750, 950], position: 1, address: '3333 Al Davis Way, Las Vegas, NV 89118 (Allegiant Stadium)' },
        { name: 'Community Cards', type: 'community-chest', position: 2 },
        { name: 'Las Vegas Grand Prix', type: 'property', color: '#8B4513', group: 'brown', price: 300, rent: [30, 60, 180, 500, 700, 900], position: 3, address: '7000 Las Vegas Blvd N, Las Vegas, NV 89115 (Las Vegas Motor Speedway)' },
        { name: 'Income Tax', type: 'tax', amount: 200, position: 4 },
        { name: 'Las Vegas Monorail', type: 'railroad', group: 'railroad', price: 250, rent: [25, 50, 100, 200], position: 5, address: '2535 S Las Vegas Blvd, Las Vegas, NV 89109' },
        { name: 'Speed Vegas Off Roading', type: 'property', color: '#87CEEB', group: 'lightBlue', price: 250, rent: [25, 50, 150, 450, 625, 750], position: 6, address: '14200 S Las Vegas Blvd, Las Vegas, NV 89054 (SPEEDVEGAS)' },
        { name: 'Chance', type: 'chance', position: 7 },
        { name: 'Las Vegas Golden Knights', type: 'property', color: '#87CEEB', group: 'lightBlue', price: 275, rent: [28, 55, 165, 495, 700, 850], position: 8, address: '3780 S Las Vegas Blvd, Las Vegas, NV 89158 (T-Mobile Arena)' },
        { name: 'Maverick Helicopter Rides', type: 'property', color: '#87CEEB', group: 'lightBlue', price: 320, rent: [32, 65, 195, 580, 800, 950], position: 9, address: '6075 S Las Vegas Blvd, Las Vegas, NV 89119' },
        { name: 'JAIL', type: 'corner', position: 10, address: 'Jail Square' },
        { name: 'Brothel', type: 'property', color: '#FF69B4', group: 'pink', price: 200, rent: [20, 40, 120, 360, 500, 600], position: 11, address: 'Nevada Brothel (Fictional)' },
        { name: 'Electric Company', type: 'utility', group: 'utility', price: 180, rent: [0, 0], position: 12 },
        { name: 'Bet MGM', type: 'property', color: '#FF69B4', group: 'pink', price: 350, rent: [35, 70, 210, 630, 875, 1050], position: 13, address: '3799 S Las Vegas Blvd, Las Vegas, NV 89109' },
        { name: 'Las Vegas Monorail', type: 'railroad', group: 'railroad', price: 250, rent: [25, 50, 100, 200], position: 14, address: '2535 S Las Vegas Blvd, Las Vegas, NV 89109' },
        { name: 'Bellagio', type: 'property', color: '#FFA500', group: 'orange', price: 400, rent: [40, 80, 240, 720, 1000, 1200], position: 15, address: '3600 S Las Vegas Blvd, Las Vegas, NV 89115' },
        { name: 'Las Vegas Aces', type: 'property', color: '#FFA500', group: 'orange', price: 300, rent: [30, 60, 180, 540, 750, 900], position: 16, address: '3950 S Las Vegas Blvd, Las Vegas, NV 89119 (Michelob ULTRA Arena)' },
        { name: 'Community Cards', type: 'community-chest', position: 17 },
        { name: 'Horseback Riding', type: 'property', color: '#FF0000', group: 'red', price: 260, rent: [26, 52, 156, 468, 650, 780], position: 18, address: 'Red Rock Canyon National Conservation Area, Las Vegas, NV' },
        { name: 'Resorts World Theatre', type: 'property', color: '#FF0000', group: 'red', price: 350, rent: [35, 70, 210, 630, 875, 1050], position: 19, address: '3000 S Las Vegas Blvd, Las Vegas, NV 89109 (Resorts World)' },
        { name: 'FREE PARKING', type: 'corner', position: 20 },
        { name: 'Hard Rock Hotel', type: 'property', color: '#FFFF00', group: 'yellow', price: 280, rent: [28, 56, 168, 504, 700, 840], position: 21, address: '3400 S Las Vegas Blvd, Las Vegas, NV 89109' },
        ...
        { name: 'Caesars Palace', type: 'property', color: '#0000FF', group: 'darkBlue', price: 420, rent: [42, 84, 252, 756, 1050, 1260], position: 30, address: '3570 S Las Vegas Blvd, Las Vegas, NV 89109' },
        { name: 'GO TO JAIL', type: 'corner', position: 31 },
        { name: 'Santa Fe Hotel and Casino', type: 'property', color: '#0000FF', group: 'darkBlue', price: 350, rent: [35, 70, 210, 630, 875, 1050], position: 32, address: '4949 N Rancho Dr, Las Vegas, NV 89130' },
        { name: 'Luxury Tax', type: 'tax', amount: 100, position: 33 },
        { name: 'Chance', type: 'chance', position: 34 },
        { name: 'House of Blues', type: 'property', color: '#0000FF', group: 'darkBlue', price: 300, rent: [30, 60, 180, 540, 750, 900], position: 35, address: '3950 S Las Vegas Blvd, Las Vegas, NV 89119 (inside Mandalay Bay)' },
        { name: 'Community Cards', type: 'community-chest', position: 36 },
        { name: 'The Cosmopolitan', type: 'property', color: '#4B0082', group: 'special', price: 350, rent: [35, 70, 210, 630, 875, 1050], position: 37, address: '3708 S Las Vegas Blvd, Las Vegas, NV 89109' },
        { name: 'Las Vegas Monorail', type: 'railroad', group: 'railroad', price: 250, rent: [25, 50, 100, 200], position: 38, address: '2535 S Las Vegas Blvd, Las Vegas, NV 89109' },
        { name: 'Speed Vegas Off Roading', type: 'property', color: '#4B0082', group: 'special', price: 275, rent: [28, 55, 165, 495, 700, 850], position: 39, address: '14200 S Las Vegas Blvd, Las Vegas, NV 89054 (SPEEDVEGAS)' }
    ];
}
...
io.on('connection', (socket) => {
    ...
    // Card decks
    const chanceCards = [
        { type: 'money', amount: 2000, message: 'Bank pays you dividend of $2000' },
        { type: 'money', amount: -500, message: 'Pay poor tax of $500' },
        { type: 'move', position: 0, message: 'Advance to GO' },
        { type: 'jail', message: 'Go to Jail' },
        { type: 'money', amount: 1000, message: 'Your building loan matures - collect $1000' },
        { type: 'money', amount: -1000, message: 'Pay hospital $1000' },
        { type: 'money', amount: 500, message: 'You have won a competition - collect $500' },
        { type: 'money', amount: -1500, message: 'Pay school tax of $1500' },
        { type: 'move', position: 5, message: 'Advance to nearest Railroad' },
        { type: 'moveRelative', delta: -3, message: 'Go back 3 spaces' },
        { type: 'money', amount: -200, message: 'Pay doctor fee $200' },
        { type: 'money', amount: 250, message: 'Receive for services $250' },
        { type: 'jail-free', message: 'Get Out of Jail Free' },
        { type: 'move', position: 15, message: 'Advance to nearest Railroad' },
        { type: 'money', amount: 1000, message: 'Interest on 7% preference shares - collect $1000' },
        { type: 'money', amount: -800, message: 'Pay insurance premium $800' }
    ];

    const communityCards = [
        { type: 'money', amount: 1000, message: 'You have won second prize in a beauty contest - collect $1000' },
        { type: 'money', amount: -500, message: 'Doctor fees - pay $500' },
        { type: 'money', amount: 2000, message: 'From sale of stock you get $2000' },
        { type: 'money', amount: -1000, message: 'Pay school tax of $1000' },
        { type: 'money', amount: 500, message: 'You inherit $500' },
        { type: 'jail-free', message: 'Get out of jail free - keep this card' },
        { type: 'money', amount: 250, message: 'Receive $250 consultation fee' },
        { type: 'money', amount: -400, message: 'Pay hospital $400' },
        { type: 'money', amount: 100, message: 'Bank error in your favor - collect $100' },
        { type: 'money', amount: 1000, message: 'Life insurance matures - collect $1000' },
        { type: 'money', amount: -500, message: 'Pay hospital $500' },
        { type: 'money', amount: 200, message: 'You have won $200 in a contest' },
        { type: 'money', amount: -800, message: 'Pay for repairs $800' },
        { type: 'money', amount: 1000, message: 'Holiday fund matures - collect $1000' },
        { type: 'money', amount: -1500, message: 'Pay tax of $1500' },
        { type: 'money', amount: 250, message: 'Receive $250 from sale' }
    ];
