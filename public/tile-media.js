...
function getVideoUrl(localPath) {
    ...
    if (USE_VIDEO_CDN && VIDEO_CDN_BASE_URL) {
        try {
            // Use the full path including Cropped directory
...
const tileMediaRaw = {
    ...
    4: { name: 'Income Tax', videos: [], images: ['/Images/income_tax.jpg'] },
    ...
    28: { name: 'Water Works', videos: [], images: ['/Images/water_works.jpg'] },
    ...
    31: { name: 'Luxury Tax', videos: [], images: ['/Images/luxury_tax.jpg'] },
    ...
    38: { name: 'Horseback Riding', videos: ['/Videos/horse6.mp4'], images: ['/Images/horseback_riding.jpg'] },
