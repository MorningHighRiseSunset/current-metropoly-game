...
const tileMediaRaw = {
    ...
    1: { name: 'Las Vegas Raiders', videos: ['/Videos/Cropped/LVRaidersVid.mp4'], images: [] },
    2: { name: 'Community Cards', videos: [], images: [] },
    3: { name: 'Las Vegas Grand Prix', videos: ['/Videos/Cropped/LV Grand Prix.mp4', '/Videos/Cropped/LV Grand Prix End.mp4'], images: [] },
    ...
    6: { name: 'Speed Vegas Off Roading', videos: ['/Videos/Cropped/Offroading 1.mp4', '/Videos/Cropped/Vegas Off-Road Experience at Speed Vegas Motorsport Park.mp4'], images: [] },
    7: { name: 'Chance', videos: [], images: [] },
    8: { name: 'Las Vegas Golden Knights', videos: ['/Videos/Cropped/LV GKnights 1.mp4', '/Videos/Cropped/LV GKnights 2.mp4', '/Videos/Cropped/LV Golden Knights.mp4'], images: [] },
    ...
    16: { name: 'Las Vegas Aces', videos: ['/Videos/Cropped/WNBA.mp4', '/Videos/Cropped/WNBAHL2.mp4', '/Videos/Cropped/WNBAHL3.mp4', '/Videos/Cropped/WNBAHL4.mp4'], images: [] },
    17: { name: 'Community Cards', videos: [], images: [] },
    18: { name: 'Santa Fe Hotel and Casino', videos: ['/Videos/Cropped/Santa Fe Hotel And Casino1.mp4', '/Videos/Cropped/Santa Fe Hotel And Casino2.mp4'], images: [] },
    19: { name: 'Resorts World Theatre', videos: ['/Videos/Cropped/Resorts World Theatre1.mp4', '/Videos/Cropped/Resorts World Theatre2.mp4', '/Videos/Cropped/Resorts World Theatre3.mp4', '/Videos/Cropped/Resorts World Theatre4.mp4'], images: [] },
    ...
    24: { name: 'Shriners Children\'s Open', videos: ['/Videos/Cropped/Shriners Childrens Open1.mp4', '/Videos/Cropped/Shriners Childrens Open2.mp4', '/Videos/Cropped/Shriners Childrens Open3.mp4'], images: [] },
    25: { name: 'Las Vegas Little White Wedding Chapel', videos: ['/Videos/Cropped/Las Vegas Little White Wedding Chapel1.mp4', '/Videos/Cropped/Las Vegas Little White Wedding Chapel2.mp4'], images: [] },
    26: { name: 'Community Cards', videos: [], images: [] },
    27: { name: 'Sphere', videos: ['/Videos/Cropped/Sphere1.mp4', '/Videos/Cropped/Sphere2.mp4'], images: [] },
    28: { name: 'Water Works', videos: [], images: [] },
    29: { name: 'Caesars Palace', videos: ['/Videos/Cropped/Caesars Palace1.mp4', '/Videos/Cropped/Caesars Palace3.mp4', '/Videos/Cropped/Caesars Palace4.mp4'], images: [] },
    30: { name: 'GO TO JAIL', videos: ['/Videos/Cropped/Imgoingtojail.mp4', '/Videos/Cropped/Jailclip4.mp4', '/Videos/Cropped/Jailclip5.mp4', '/Videos/Cropped/Jailmoment2(cropped).mp4', '/Videos/Cropped/jailclip6.mp4_1743296163946.mp4', '/Videos/Cropped/jailmoment3(cropped).mp4'], images: [] },
    31: { name: 'Luxury Tax', videos: [], images: [] },
    32: { name: 'Chance', videos: [], images: [] },
    33: { name: 'House of Blues', videos: ['/Videos/Cropped/House Of Blues1.mp4', '/Videos/Cropped/House Of Blues2.mp4', '/Videos/Cropped/House Of Blues3.mp4'], images: [] },
    34: { name: 'Bet MGM', videos: ['/Videos/Cropped/MGMBoxing 1.mp4', '/Videos/Cropped/MGMBoxing 3.mp4'], images: [] },
    35: { name: 'Wynn Las Vegas', videos: ['/Videos/Cropped/Wynn Las Vegas1.mp4', '/Videos/Cropped/Wynn Las Vegas2.mp4', '/Videos/Cropped/Wynn Las Vegas3.mp4'], images: [] },
    36: { name: 'The Cosmopolitan', videos: ['/Videos/Cropped/The Cosmopolitan1.mp4', '/Videos/Cropped/The Cosmopolitan2.mp4', '/Videos/Cropped/The Cosmopolitan3.mp4'], images: [] },
    37: { name: 'Las Vegas Monorail', videos: ['/Videos/Cropped/Las Vegas Monorail1.mp4', '/Videos/Cropped/Las Vegas Monorail2.mp4'], images: [] },
    38: { name: 'Horseback Riding', videos: ['/Videos/Cropped/horse6.mp4'], images: [] },
    39: { name: 'Speed Vegas Off Roading', videos: ['/Videos/Cropped/Offroading 1.mp4', '/Videos/Cropped/Vegas Off-Road Experience at Speed Vegas Motorsport Park.mp4'], images: [] }
};
