...
function getVideoUrl(localPath) {
    ...
    // For local paths, don't encode - browser handles it automatically
    return localPath;
}
...
const tileMediaRaw = {
    ...
    3: { name: 'Las Vegas Grand Prix', videos: ['/Videos/LV_Grand_Prix.mp4', '/Videos/LV_Grand_Prix_End_(1).mp4'], images: [] },
    4: { name: 'Income Tax', videos: [], images: [] },
    5: { name: 'Las Vegas Monorail', videos: ['/Videos/Monorail_(1).mp4'], images: [] },
    6: { name: 'Speed Vegas Off Roading', videos: ['/Videos/Offroading_1_(1).mp4'], images: ['/images/SpeedVegasOffroading.jpg', '/images/SV_OFF_ROAD_TRACK_GALLERY_6.jpg'] },
    7: { name: 'Chance', videos: [], images: [] },
    8: { name: 'Las Vegas Golden Knights', videos: ['/Videos/LV_GKnights_1_(1).mp4', '/Videos/LV_GKnights_2_(1).mp4', '/Videos/LV_Golden_Knights_(1).mp4'], images: ['/images/230613231941-04-knights-stanley-cup-061323.jpg'] },
    9: { name: 'Maverick Helicopter Rides', videos: ['/Videos/MavHeli_2_(1).mp4', '/Videos/MavHeli_3_(1).mp4'], images: ['/images/HelicopterRidesNight.jpg', '/images/702-helicopters.webp'] },
    10: { name: 'JAIL', videos: [], images: [] },
    11: { name: 'Brothel', videos: ['/Videos/BrothelVid_(1).mp4'], images: [] },
    12: { name: 'Electric Company', videos: [], images: [] },
    13: { name: 'Bet MGM', videos: ['/Videos/MGMBoxing_1_(1).mp4', '/Videos/MGMBoxing_3_(1).mp4'], images: ['/images/BetMGM.jpg'] },
    14: { name: 'Las Vegas Monorail', videos: ['/Videos/Monorail_(1).mp4'], images: [] },
    15: { name: 'Bellagio', videos: [], images: ['/images/bellagio.jpg'] },
    16: { name: 'Las Vegas Aces', videos: ['/Videos/WNBA_(1).mp4', '/Videos/WNBAHL2_(1).mp4', '/Videos/WNBAHL3_(1).mp4', '/Videos/WNBAHL4_(1).mp4'], images: [] },
    17: { name: 'Community Cards', videos: [], images: [] },
    18: { name: 'Horseback Riding', videos: ['/Videos/horse6_(1).mp4'], images: [] },
    ...
    28: { name: 'Sphere', videos: ['/Videos/Sphere_(1).mp4'], images: ['/images/LasVegasSphere.jpg', '/images/thesphere.jpg', '/images/PIX-1-Exosphere-Architecture.jpg'] },
    ...
    38: { name: 'Las Vegas Monorail', videos: ['/Videos/Monorail_(1).mp4'], images: [] },
